...
router.delete("/images/:postId", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var postId, userId, post, imagePath, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 1:
                ...
                return [4 /*yield*/, post_model_1.default.deleteOne({ _id: postId })];
            case 2:
                // Delete the post from the database
                _a.sent();
                // Delete associated comments
                return [4 /*yield*/, comments_model_1.default.deleteMany({ post: postId })];
            case 3:
                // Delete associated comments
                _a.sent();
